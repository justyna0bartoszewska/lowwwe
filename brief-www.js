$("#brief-www").validator().on("submit", function (event) {
...
function formError(){
    $("#brief-www").removeClass().addClass('shake animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
        $(this).removeClass();
    });
}
